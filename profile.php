<?php
$page_title = __('profile_title') ?: 'Profile';
    ...
    <div class="col-lg-4">
        ...
        <div class="db-card db-fade-in">
            <div class="db-card-header">
                <h5 class="db-card-title"><i class="fas fa-chart-pie"></i> <?php _e('profile_your_stats'); ?></h5>
            </div>
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            <div class="db-form-group">
                                ...
                                <small class="text-muted"><?php _e('profile_email_change_note'); ?></small>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="db-form-group">
                        ...
                        <div class="col-12">
                            <div class="db-form-group">
                                ...
                                <small class="text-muted"><?php _e('profile_olymptrade_id_note'); ?></small>
                            </div>
                        </div>
                    </div>
