<?php
$page_title = __('admin_dash_title') ?: 'Dashboard';
...
<div class="page-header">
    <div>
        <h1 class="page-title"><i class="fas fa-tachometer-alt"></i> <?php _e('admin_dash_title'); ?></h1>
        <p class="page-subtitle"><?php _e('admin_dash_subtitle'); ?></p>
    </div>
...
<div class="stat-grid">
    ...
    <div class="stat-card warning fade-in">
        ...
        <div class="stat-label"><?php _e('admin_stat_pending_verification'); ?></div>
    </div>
    ...
    <div class="stat-card success fade-in">
        ...
        <div class="stat-label"><?php _e('admin_stat_active_users'); ?></div>
    </div>
    ...
    <div class="stat-card <?php echo $winRate >= 70 ? 'success' : ($winRate >= 50 ? 'warning' : 'danger'); ?> fade-in">
        ...
        <div class="stat-label"><?php _e('admin_stat_today_winrate'); ?></div>
    </div>
    ...
    <div class="stat-card primary fade-in">
        ...
        <div class="stat-label"><?php _e('admin_stat_monthly_revenue'); ?></div>
    </div>
</div>
...
<div class="alert alert-warning fade-in">
    ...
    <div>
        <strong><?php echo $pendingVerifications; ?></strong> <?php _e('admin_pending_users_alert'); ?>
    ...
    <div class="col-lg-4">
        <div class="admin-card fade-in">
            <div class="admin-card-header">
                <h5 class="admin-card-title"><i class="fas fa-pie-chart"></i> <?php _e('admin_package_distribution'); ?></h5>
            </div>
                ...
                <div class="package-stats">
                    ...
                    <div class="package-stat-item">
                        <div class="d-flex align-items-center justify-content-between mb-2">
                            ...
                            <span class="text-muted small"><?php echo $count; ?> <?php _e('admin_users_label'); ?></span>
                        </div>
        ...
        <div class="admin-card fade-in">
            ...
            <div class="admin-card-body" style="padding: 0;">
                ...
                <div class="empty-state">
                    ...
                    <p class="empty-state-desc"><?php _e('admin_no_trades_yet'); ?></p>
                </div>
                <?php else: ?>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <?php else: ?>
                                <span class="badge badge-warning"><?php _e('admin_pending_label'); ?></span>
                                <?php endif; ?>
                            </td>
...
<div class="admin-card mt-4 fade-in">
    <div class="admin-card-header">
        <h5 class="admin-card-title"><i class="fas fa-user-plus"></i> <?php _e('admin_recent_registrations'); ?></h5>
        ...
        <div class="table-responsive">
            <table class="admin-table">
                <thead>
                    <tr>
                        <th><?php _e('admin_th_user'); ?></th>
                        <th><?php _e('admin_th_email'); ?></th>
                        <th><?php _e('admin_th_country'); ?></th>
                        <th><?php _e('admin_th_olymptrade_id'); ?></th>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <div class="action-btns">
                                <a href="verify-users.php" class="btn btn-sm btn-success btn-icon" title="<?php echo __('admin_btn_review'); ?>">
                                    <i class="fas fa-user-check"></i>
                                </a>
                            </div>
                            <?php else: ?>
                            <a href="users.php?search=<?php echo urlencode($user['email']); ?>" class="btn btn-sm btn-outline-primary btn-icon" title="<?php echo __('admin_btn_view_details'); ?>">
