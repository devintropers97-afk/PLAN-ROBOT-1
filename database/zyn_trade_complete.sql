-- =============================================
-- ZYN TRADE SYSTEM - COMPLETE DATABASE SCHEMA
-- =============================================
-- Version: 3.1 Premium Edition
-- "Precision Over Emotion"
-- =============================================
--
-- FILE INI SUDAH LENGKAP - CUKUP IMPORT SEKALI SAJA!
--
-- CARA IMPORT:
-- 1. Login ke phpMyAdmin di cPanel
-- 2. Buat database baru (misal: zyn_trade)
-- 3. Pilih database tersebut
-- 4. Klik tab "Import"
-- 5. Pilih file ini (zyn_trade_complete.sql)
-- 6. Klik "Go" / "Import"
--
-- ADMIN LOGIN:
...
CREATE TABLE `users` (
    ...
    INDEX `idx_badge_points` (`badge_points` DESC)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
