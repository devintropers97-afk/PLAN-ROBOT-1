<?php
/**
 * ZYN Trade System - Profit Calculator
            ...
            <div class="col-lg-10">
                        ...
                        <div id="strategyMode">
                            <div class="row g-3">
                                <div class="col-md-6">
                                    ...
                                    <small class="text-muted"><?php _e('calc_minimum'); ?></small>
                                </div>
                                <div class="col-md-6">
                        ...
                        <div id="manualMode" style="display: none;">
                            <div class="row g-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <small class="text-muted"><?php _e('calc_daily_hint'); ?></small>
                                </div>
                                <div class="col-12">
                                    <label class="form-label"><?php _e('calc_monthly_days'); ?></label>
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-hover">
                                <thead class="table-dark">
                                    <tr>
                                        <th><?php _e('calc_strategy_table'); ?></th>
                                        <th><?php _e('stats_win_rate'); ?></th>
                                        <th>Tier</th>
                                        <th><?php _e('calc_per_month'); ?>*</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr>
                        ...
                        <small class="text-muted"><?php _e('calc_estimate_hint'); ?></small>
                    </div>
                </div>
